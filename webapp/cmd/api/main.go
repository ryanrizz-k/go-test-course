...
func main() {
	...
	flag.StringVar(&app.DSN, "dsn", "host=localhost port=5435 user=postgres password=postgres dbname=users sslmode=disable timezone=UTC connect_timeout=5", "Postgres connection")
